...
public class Project {
    ...
    public void setRepositoryUrl(String v) { repositoryUrl = v; }
    public void setDeployUrl(String v) { deployUrl = v; }
    public void setAverageRating(Double v) { averageRating = v; }
    public void setUpvotes(Integer v) { upvotes = v; }
    public void setProfile(Profile v) { profile = v; }
    public void setTechnologies(Set<Technology> v) { technologies = v; }
}
